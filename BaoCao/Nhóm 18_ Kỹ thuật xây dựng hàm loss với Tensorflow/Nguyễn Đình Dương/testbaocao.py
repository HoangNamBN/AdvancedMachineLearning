...
df = pd.read_csv('C:/hoc_may/2015.csv')
print(df)
#print (df.columns)
...
X_LabelEncoder = df_LabelEncoder.drop('Freedom',axis=1)
y_LabelEncoder = df_LabelEncoder['Freedom']
...
plt.xticks(())
plt.yticks(())
plt.title('Linear regression for 2015')
plt.xlabel('X')
plt.ylabel('y')
